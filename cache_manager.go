...
// InvalidateByServerName clears the cached profile for a given serverName and
// immediately triggers an async re-probe. Uses DoProbe singleflight to prevent
// concurrent probe storms.
func (m *CacheManager) InvalidateByServerName(serverName, dest, alpn string) {
